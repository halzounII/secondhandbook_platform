...
function bookStat($textBookName){  //回傳現有已註冊的書籍統計資料(金額與對應數量)
    $lookUp = $conn->prepare("SELECT * FROM books WHERE (bookName) VALUES (?)"); // still have syntax error here; needs fixing
